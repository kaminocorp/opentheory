      ...
      <section className="grid gap-8">
        <div className="grid gap-6 lg:grid-cols-[1fr_360px] lg:items-end">
          <div className="max-w-3xl">
            {/* Modest title — weight carries hierarchy, not size. */}
          ...
          {/* A small card of metric readouts: muted label + mono value. */}
          <Bay density="none" className="self-stretch lg:self-end">
