...
the still-owed browser eyeball pass. Concurrent campaign cycles shipped in
`0.32.0`. Deepdive Phase D shipped in `0.31.0` (shareable Research deep
links; no sidecar). Deepdive Phase C polish shipped in `0.30.0` (historical
