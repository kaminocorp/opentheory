...
| `table.create` | See & record | `0.34.0` | Typed table artifact — exact cells or labels; floats rejected |
| `table.derive_column` | See & record | `0.34.0` | Computed column — exact, blamable; relation may refute |
